...
This is accomplished through
    ...
    ,576 as sessionnum
    ,240500576 as data_id
    ,'20260423a' as sys_temp1
    ,20260423 as sys_temp2
    ...
    and ( vbed.rec_status_code is null or (vbed.rec_status_code < 100 and vbed.rec_status_code <> 15) )
    and d.loc_id not in
