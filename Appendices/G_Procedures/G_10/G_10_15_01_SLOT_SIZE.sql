...
inner join MOE_20230324.dbo.TblScreen as moes
...
,convert(varchar(50),moes.Slot) as YC_SLOT
,cast(null as float) as CONV_YC_SLOT
into MOE_20230324.dbo.YC_20230324_MOE_SLOT
from 
MOE_20230324.dbo.YC_20230324_BH_ID as ycb
inner join MOE_20230324.dbo.TblPipe as moep
on ycb.BORE_HOLE_ID=moep.Bore_Hole_ID
...
from 
MOE_20230324.dbo.YC_20230324_MOE_SLOT as ycm

update [MOE_20230324].dbo.YC_20230324_MOE_SLOT
set
