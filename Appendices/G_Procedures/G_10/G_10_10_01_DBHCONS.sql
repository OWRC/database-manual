...
,moec.CASING_DIAMETER_UOM as [CON_DIAMETER_UNIT_OUOM]
,convert(varchar(255),null) as CON_COMMENT
into MOE_20250711.dbo.YC_20250711_DBHCONS
from 
MOE_20250711.dbo.YC_20250711_BH_ID as y
inner join MOE_20250711.dbo.TblPipe as moep
on y.BORE_HOLE_ID=moep.Bore_Hole_ID
...
-- v20230324 19598 rows
-- v20240326 25011 rows
-- v20250711 19409 rows

insert into MOE_20250711.dbo.YC_20250711_DBHCONS
...
,[CON_COMMENT]
FROM MOE_20250711.[dbo].[YC_20250711_DBHCONS]
where
CON_TOP_OUOM>CON_BOT_OUOM
--and CON_COMMENT is not null

update MOE_20250711.[dbo].[YC_20250711_DBHCONS]
set
CON_TOP_OUOM=CON_BOT_OUOM
...
--drop table yc_20250711_dbhcons

-- check temporary dbhcons table

-- v20240326 33681 records
-- v20250711 26039 rows

select * from MOE_20250711.[dbo].[YC_20250711_DBHCONS]
