...
,COUNT(*) as rcount
from 
MOE_20240326.dbo.YC_20240326_DINTMON ycdim
group by
ycdim.TMP_LOC_ID
) as test
...
-- table we're using, i.e. YC_20240326_BH_ID, should not (and does not)
...
ycb.BORE_HOLE_ID
,COUNT(*) as rcount
FROM MOE_20240326.[dbo].YC_20240326_BH_ID as ycb
