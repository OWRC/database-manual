...
-- v20240326 74604 in master db
-- v20250711 74665 in master db
...
*
from 
moe_20250711.dbo.m_r_bh_driller_code
order by
bh_driller_code
...
-- v20240326 74605 min 74641 max
-- v20250711 74694 min 74721 max
...
from 
moe_20250711.dbo.m_d_location as md
...
select * from oak_20160831_master.dbo.r_loc_township_code
...
delete from MOE_20250711.dbo.m_d_location_purpose
where
sys_record_id in
(
select
